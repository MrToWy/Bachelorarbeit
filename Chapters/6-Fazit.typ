...
Durch die modernen Oberflächen sollte es Studierenden und studieninteressierten Personen leichtfallen, an die gewünschten Informationen zu bestimmten Modulen oder einem Studiengang zu gelangen. Für die dozierenden Personen an der #hsh sollte die Aktualisierung der Modultexte dank der intuitiven Eingabefelder sowie der unterstützenden Plausibilitätsprüfung angenehmer sein. Die Generierung eines PDFs läuft jetzt weitestgehend automatisch, sodass der Studiengangsdekan für diese Aufgabe nun weniger Zeit benötigen sollte.
...
Zusätzlich zu den Modulhandbüchern und dem Anhang der Prüfungsordnung könnte ebenso die in @definition genannte Abbildung des Curriculums (@mdiCurr) generiert und im neuen System angezeigt werden.
